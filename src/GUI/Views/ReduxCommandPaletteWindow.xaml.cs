...
public partial class ReduxCommandPaletteWindow : AdonisUI.Controls.AdonisWindow
{
	...
	private static string GetCommandIconKey(string commandId) => commandId switch
	{
		...
		nameof(AppKeys.ToggleModFileNames) => "document",
		nameof(AppKeys.ToggleOverrideMods) => "chevron-up",
		...
		nameof(AppKeys.OpenSaveGameManager) => "book-open",
		nameof(AppKeys.OpenGameDirectoryModManager) => "blocks",
		nameof(AppKeys.OpenNexusDownloads) => "download",
	...
	private static string GetCommandSearchTerms(string commandId) => commandId switch
	{
		...
		nameof(AppKeys.ToggleModFileNames) => "filename file name column show hide toggle",
		nameof(AppKeys.ToggleOverrideMods) => "override mods pane collapse expand toggle",
		...
		nameof(AppKeys.OpenSaveGameManager) => "manager install import delete thumbnail lsv zip saves",
		nameof(AppKeys.OpenGameDirectoryModManager) => "native dll root game directory manager install remove delete uninstall restore rollback loader",
